...
__Bob (Robert) Dooling__

__Cybersecurity and Risk Management Advisor__
...
* Enabled clients to identify, prioritize, and remediate technology risks.
* Led and executed full scope red team engagements, collaborative red / blue team services, regulatory compliance gap analysis, and holistic security program assessments.
...
* Broad experience conducting methodical assessments
* Excels in roles that combine business and technical acumen  
...
* CISSP \#121592 – (ISC)2 GICSP (Industrial Control Systems)
...
* SANS InfoSec Python course
* SANS Exploit Development course


**EDUCATION**

James Madison University - BBA: Finance; MIS Dual major focused on economics, finance, and information security
